package  {
	...
	public class Level {
		...
		private var enemy;
		public var enemySpawn:Number = 0.25; //seconds
		...
		public function Level(args){
			...
			var life = new Lives();
			var sidePad = (stage.stageWidth-3*pad-3*life.width-shieldy.width)/2;
			shieldy.x = stage.stageWidth-shieldy.width/2-sidePad;
			shieldy.y = core.y+core.height/2+pad*3;
		...
		function enemyTimer(e){
			...
			if(enemyHolder.numChildren < enemyMaxNum && rand(1,enemyProb) == 1){
