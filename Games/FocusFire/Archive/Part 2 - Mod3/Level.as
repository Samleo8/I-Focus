package  {
	...
	public class Level {
		...
		public var playerHealthLoss = 10;
		...
		private var enemy;
		public var enemySpawn:Number = 2.5; //seconds
		...
		public function Level(args){
			...
			var sidePad = (stage.stageWidth-(nitems-1)*pad-healthbar.width-shieldy.width-ammotype.width)/2;
			ammotype.x = stage.stageWidth-ammotype.width/2-sidePad; 
			shieldy.x = ammotype.x-pad-ammotype.width/2-shieldy.width/2;
			healthbar.y = ammotype.y = shieldy.y = core.y+core.height/2+pad*3;
			...
			*/
			healthbar.x = sidePad+healthbar.width/2; 
			
			alertHolder.addChild(healthbar);
