package  {
	...
	public class Level {
		...
		private var i,j;
		private var target;
		public var targetPadding:Number = 15;
		public var targetNo:Number = 30; //number of targets for the width
		private var targetHeightNo:Number;
		public var targetWidth:Number;
		public var ttlEnemies:Number = 10; //number of enemies on the stage at every instant
		public var enemyDisappearTime:Number = 10; //seconds before enemy disappears
		...
		public function panLvl(dir){
			...
			levelObj.x = Math.max(Math.min(levelObj.x,levelObj.width/2),stage.stageWidth-levelObj.width/2);
			levelObj.y = Math.max(Math.min(levelObj.y,levelObj.height/2),stage.stageHeight-levelObj.height/2);
		}
		//Target Check
